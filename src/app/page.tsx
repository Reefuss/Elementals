    ...
    >
      ...
      >
        ...
        <div className="space-y-4 text-sm text-white/70 leading-relaxed">
          <Rule emoji="🎯" title="Goal">First player to collect <strong className="text-white">3 points</strong> wins.</Rule>
          <Rule emoji="🃏" title="Your Deck">20 cards: 5 Sun, 5 Moon, 5 Star, and 5 Special. Draw 4 to start, then 1 per round.</Rule>
          ...
          <Rule emoji="💎" title="Same Element">Higher value wins (+8 &gt; +5 &gt; +3). Equal values tie.</Rule>
        ...
        {(screen === "menu" || screen === "result") && (
          ...
          >
            ...
            <div className="flex gap-6 text-2xl">
              <motion.span animate={{ rotate: [0,15,-15,0] }} transition={{ duration: 3, repeat: Infinity, delay: 0 }}
                className="text-sun-400 drop-shadow-[0_0_8px_rgba(251,191,36,0.8)]">☀</motion.span>
              <motion.span animate={{ rotate: [0,-15,15,0] }} transition={{ duration: 3, repeat: Infinity, delay: 0.5 }}
                className="text-moon-300 drop-shadow-[0_0_8px_rgba(147,197,253,0.8)]">☽</motion.span>
              <motion.span animate={{ rotate: [0,20,-20,0] }} transition={{ duration: 3, repeat: Infinity, delay: 1 }}
                className="text-star-400 drop-shadow-[0_0_8px_rgba(232,121,249,0.8)]">★</motion.span>
            </div>
